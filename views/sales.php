...
$sold_outs_query = "SELECT products.name, products.selling_price, sold_out.id, sold_out.quantity, sold_out.product_id, outlets.id AS outlet_id, outlets.name, outlets.company_id FROM products JOIN sold_out ON products.id = sold_out.product_id JOIN outlets ON sold_out.outlet_id = outlets.id;";
    ...
    <div class="row flex-nowrap">
        <div class="side-nav col-auto col-md-3 col-xl-2 px-sm-2 px-0">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100 sticky-top">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    <a href="/views/sales.php" class="d-flex align-items-center text-dark text-decoration-none fs-4">
        ...
        <div class="col py-3">
            <div class="container user">
                ...
                <h1 class="my-4 bg-light"><?php echo $company['name'] ?> Sales</h1>
